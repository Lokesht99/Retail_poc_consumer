...
import { baseImagePath } from "../../common/app.config";
            ...
            <div className="col-lg-5">
              ...
              >
                <div className="ratio ratio-1x1 rounded d-none d-lg-block">
                  <img
                    className=""
                    src={`${baseImagePath}/books%2F${product.images[selectedIndex].name}?alt=media`}
                    alt="Product image."
                  ...
                  {product.images.map((img, i) => {
                    return (
                      ...
                      >
                        <img
                          className="p-2"
                          src={`${baseImagePath}/books%2F${img}?alt=media`}
                          alt="Product image."
                          style={{ objectFit: "contain" }}
                        />
                      </div>
              ...
              {product.images?.map((e, i) => {
                return (
                  ...
                  >
                    <img
                      className="p-1"
                      src={`${baseImagePath}/books%2F${e}?alt=media`}
                      alt="Product image."
                      style={{ objectFit: "contain" }}
                    />
                  </div>
